...
ultrafeedback_dataset_path = 'openbmb/UltraFeedback'
...
class ScriptArguments:
    ...
    dataset: Optional[str] = field(default='HH-RLHF', metadata={"help": "dataset name, 'HH-RLHF' or 'UltraFeedback' "})

parser = HfArgumentParser(ScriptArguments)
script_args = parser.parse_args_into_dataclasses()[0]
exp_type = script_args.dataset
script_args.wandb_name = script_args.wandb_name
...
reward_path_tokenizer_dict = {
    ...
    'hh-rlhf-helpful': ['Ray2333/gpt2-large-helpful-reward_model'],
    'humor': ['mohameddhiab/humor-no-humor'],
    'IF': ['INSTRUCTION_FOLLOWING_REWARD_MODEL_PATH'],
    'honest': ['HONEST_REWARD_MODEL_PATH'],
    'truthful': ['TRUTHFUL_REWARD_MODEL_PATH'],
    'ultrafeedback-helpful': ['HELPFUL_REWARD_MODEL_PATH']
}
...
if exp_type == 'HH-RLHF':
    ...
    dataset = build_dataset_summary(ultrafeedback_dataset_path, tokenizer, rm_tokenizer, split='train')
    instructions = Instructions()
