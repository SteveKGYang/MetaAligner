...
class CDPORewardDataset(Dataset):
    """
    ...
    def __init__(
        ...
        #     )
        for query, chosen_response, reject_response in zip(
                queries, chosen_responses, reject_responses):
            ...
            self.chosens.append(chosen_response)
            self.rejects.append(reject_response)
