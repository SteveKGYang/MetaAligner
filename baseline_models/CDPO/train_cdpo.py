...
from CDPO_reward_dataset import CDPORewardDataset
...
def train(args):
    ...
    train_data_dir = os.path.join(args.dataset, 'train.csv')
    train_dataset = CDPORewardDataset(
        train_data_dir, tokenizer, args.max_len, strategy, input_template=None, is_dpo=True
    )
    eval_data_dir = os.path.join(args.dataset, 'val.csv')
    eval_dataset = CDPORewardDataset(
        eval_data_dir, tokenizer, args.max_len, strategy, input_template=None, is_dpo=True
    )
